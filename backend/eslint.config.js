...
module.exports = [
...

  {
    ...
    rules: {
      ...
      'no-unused-vars': ['warn', { 'argsIgnorePattern': '^_', 'varsIgnorePattern': '^_' }], // Affiche un avertissement pour les variables non utilisées (au lieu d'une erreur), sauf si elles commencent par _
    },
  }
];
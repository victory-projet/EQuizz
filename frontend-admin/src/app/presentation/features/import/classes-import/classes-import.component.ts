...
import { CLASSES_IMPORT_CONFIG } from '../../../shared/components/excel-import/import-configs';
import { ImportResult } from '../../../../core/services/import.service';

@Component({
  selector: 'app-classes-import',
  standalone: true,
...
export class ClassesImportComponent {
  @Output() imported = new EventEmitter<ImportResult>();
  @Output() cancelled = new EventEmitter<void>();

  importConfig = CLASSES_IMPORT_CONFIG;

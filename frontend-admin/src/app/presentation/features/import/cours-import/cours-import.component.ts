...
import { COURS_IMPORT_CONFIG } from '../../../shared/components/excel-import/import-configs';
import { ImportResult } from '../../../../core/services/import.service';

@Component({
  selector: 'app-cours-import',
  standalone: true,
...
export class CoursImportComponent {
  @Output() imported = new EventEmitter<ImportResult>();
  @Output() cancelled = new EventEmitter<void>();

  importConfig = COURS_IMPORT_CONFIG;

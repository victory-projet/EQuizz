...
import { ETUDIANTS_IMPORT_CONFIG } from '../../../shared/components/excel-import/import-configs';
import { ImportResult } from '../../../../core/services/import.service';

@Component({
  selector: 'app-etudiants-import',
  standalone: true,
...
export class EtudiantsImportComponent {
  @Output() imported = new EventEmitter<ImportResult>();
  @Output() cancelled = new EventEmitter<void>();

  importConfig = ETUDIANTS_IMPORT_CONFIG;

...
import { ENSEIGNANTS_IMPORT_CONFIG } from '../../../shared/components/excel-import/import-configs';
import { ImportResult } from '../../../../core/services/import.service';

@Component({
  selector: 'app-enseignants-import',
  standalone: true,
...
export class EnseignantsImportComponent {
  @Output() imported = new EventEmitter<ImportResult>();
  @Output() cancelled = new EventEmitter<void>();

  importConfig = ENSEIGNANTS_IMPORT_CONFIG;

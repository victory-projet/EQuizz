...
import { QuizSubmission, QuizAnswer } from '../../entities/quiz.entity';
import { IQuizRepository, IQuizSubmissionRepository } from '../../repositories/quiz.repository.interface';

...
import { Quiz, Question, QuizSubmission } from '../../domain/entities/quiz.entity';
import { IQuizRepository, IQuizSubmissionRepository, QuizStatistics } from '../../domain/repositories/quiz.repository.interface';

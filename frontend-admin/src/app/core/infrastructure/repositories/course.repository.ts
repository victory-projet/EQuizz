...
import { Course, Teacher } from '../../domain/entities/course.entity';
import { ICourseRepository, ITeacherRepository } from '../../domain/repositories/course.repository.interface';
